  ...
  return (
    <footer className="flex bg-main-color text-white p-4 font-textFont justify-center">
      <div className="redes flex flex-col text-center justify-center items-center">
        ...
        <a href="[insta Marcos]" className="flex flex-col items-center justify-center">
          <Image
            src={logoInsta}
        ...
        <a href="[insta Lígia]" className="flex flex-col items-center justify-center">
          <Image src={logoInsta} alt="Instagram Lígia" width={30} height={30} />
          <p>Lígia Cavallari</p>
        </a>
        </div>
      </div>
